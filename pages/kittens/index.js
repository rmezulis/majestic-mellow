    ...
    return (
        <div className="container py-4">
            ...
            <Jumbotron className="bg-color">
                ...
                <p>
                    All kittens will have FIFe pedigree, Eourpian Union veterianry passport, identification microchip,
                    signed contract.
                </p>
                <p>
                    Kittens to new homes could leave at the age of 14-16 weeks old. Fully vacinated against virus
                    diseases and rabies, checked by veterinarian, skillful to eat by themselves and use the litter box.
